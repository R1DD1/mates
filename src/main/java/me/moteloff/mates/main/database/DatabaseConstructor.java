...
public class DatabaseConstructor {
    ...
    public String CREATE_PLAYER = "INSERT INTO 'mates' (`NickName`,`password`,`vkID`,`seen`) VALUES  (?,?,?,?)";
    ...
    public void createTable() {
        try {
            ...
            String CREATE_TABLES = "CREATE TABLE IF NOT EXISTS 'mates' (`id` INTEGER, `NickName` VARCHAR(16) NULL DEFAULT NULL , `password` VARCHAR(32) NULL DEFAULT NULL , `vkID` INT NULL DEFAULT NULL ,`seen` VARCHAR(200) NULL DEFAULT NULL , PRIMARY KEY (`id`));";
